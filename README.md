...
Edit Incident Command forms in a web browser, no PDF involved! They
are pixel-perfect, scalable, SVG duplicates of the FEMA PDF forms
with superimposed HTML fields on a separate plane, so they are easy on
your browser's renderer and super-simple to modify and incorporate into
your own code.
...
automating the ICS workflow, co-developers wanted. This Python3 program
requires Flask, and should work on any platform that supports Python3.
